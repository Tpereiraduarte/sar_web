...
Route::group(['middleware'=>['auth']],function(){
    ...
    Route::get('resposta/normasmobile', 'RespostaFormulariosController@normasmobile')->name('resposta.normasmobile');
    Route::get('resposta/historico', 'RespostaFormulariosController@historico')->name('resposta.historico');
    Route::post('resposta/relatoriomobile', 'RespostaFormulariosController@relatoriomobile')->name('resposta.relatoriomobile');
