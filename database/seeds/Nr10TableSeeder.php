...
class Nr10TableSeeder extends Seeder
{
    ...
    public function createSubParagrafos(){
        ...
        $paragrafo1 = DB::table('paragrafos')->where('numero_paragrafo','10.1')->first();
        $sub1 = $paragrafo1->id_paragrafo;
        
        $paragrafo2 = DB::table('paragrafos')->where('numero_paragrafo','10.2')->first();
        $sub2 = $paragrafo2->id_paragrafo;
        
        $paragrafo3 = DB::table('paragrafos')->where('numero_paragrafo','10.2.8')->first();
        $sub3 = $paragrafo3->id_paragrafo;
        
        $paragrafo4 = DB::table('paragrafos')->where('numero_paragrafo','10.2.9')->first();
        $sub4 = $paragrafo4->id_paragrafo;
        
        $paragrafo5 = DB::table('paragrafos')->where('numero_paragrafo','10.3')->first();
        $sub5 = $paragrafo5->id_paragrafo;
        
        $paragrafo6 = DB::table('paragrafos')->where('numero_paragrafo','10.4')->first();
        $sub6 = $paragrafo6->id_paragrafo;
        
        $paragrafo7 = DB::table('paragrafos')->where('numero_paragrafo','10.5')->first();
        $sub7 = $paragrafo7->id_paragrafo;
        
        $paragrafo8 = DB::table('paragrafos')->where('numero_paragrafo','10.6')->first();
        $sub8 = $paragrafo8->id_paragrafo;
        
        $paragrafo9 = DB::table('paragrafos')->where('numero_paragrafo','10.7')->first();
        $sub9 = $paragrafo9->id_paragrafo;
        
        $paragrafo10 = DB::table('paragrafos')->where('numero_paragrafo','10.8')->first();
        $sub10 = $paragrafo10->id_paragrafo;
        
        $paragrafo11 = DB::table('paragrafos')->where('numero_paragrafo','10.9')->first();
        $sub11 = $paragrafo11->id_paragrafo;
        
        $paragrafo12 = DB::table('paragrafos')->where('numero_paragrafo','10.10')->first();
        $sub12 = $paragrafo12->id_paragrafo;
        
        $paragrafo13 = DB::table('paragrafos')->where('numero_paragrafo','10.11')->first();
        $sub13 = $paragrafo13->id_paragrafo;
        
        $paragrafo14 = DB::table('paragrafos')->where('numero_paragrafo','10.12')->first();
        $sub14 = $paragrafo14->id_paragrafo;
        
        $paragrafo15 = DB::table('paragrafos')->where('numero_paragrafo','10.13')->first();
        $sub15 = $paragrafo15->id_paragrafo;
        
        $paragrafo16 = DB::table('paragrafos')->where('numero_paragrafo','10.14')->first();
