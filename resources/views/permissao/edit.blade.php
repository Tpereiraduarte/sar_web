            ...
            @csrf
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" onkeypress="return lettersOnly(event);" class="form-control" id="nome" placeholder="Nome da Permissão" name="nome" value="{{$dados->nome}}" maxlength="300" size="50" required>
                </div>
                <div class="form-group">
